<html>
    ...
    <body>
        ...
        <p class="vol">
        A Secure and Easy To Use Payment Gateway<br> Make Life Easier and Faster<br>
        </p>
        ...
        <div class="container">
            <div class="row">
                <div class="donatebox">
                    ...
                    <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_G3P9Kqh1snJNsW"> </script> </form>
                    </div>
            </div>
        </div>
